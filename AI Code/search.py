...
def depth_first_search(gp,pop_index=-1):return graphSearch(gp,pop_index)
dfsresult=depth_first_search(gp)
print("dfs Path :",dfsresult.solution(),"path cost:",dfsresult.path_cost)


print()
 
def breadth_first_search(gp,pop_index=0):return graphSearch(gp,pop_index)
bfsresult=breadth_first_search(gp)
print("bfs Path :",bfsresult.solution(),"path cost:",bfsresult.path_cost)
...
print("astar Path :",astarresult.solution(),"path cost:",ucsresult.path_cost)